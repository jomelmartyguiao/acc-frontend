...
for (let i = 1; i < 10; i++) {
	dataSource.push({
		...
		id: i,
		content: `Author Page`,
		posttitle: "Information about a personnel",
		status: [`Published`],
        ...
        return (
            <Fragment>
                <div className="site-card-wrapper">
					...
					<h1 className="module-title">Create Posts</h1>
					<span className="module-subtitle">Manage of Posts</span>
					<Row gutter={16}>
                ...
                <Modal
					title={
						<div className="modal-header">
							<p> Create Post</p>
							<small>Fill out the form for new post.</small>
						</div>
					}
